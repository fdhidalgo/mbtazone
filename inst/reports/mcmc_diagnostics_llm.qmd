...
# Source R functions
source_path <- if (dir.exists("R")) "R" else "../R"
source(file.path(source_path, "config.R"))
source(file.path(source_path, "parcel_metrics.R"))
source(file.path(source_path, "parcel_multichain.R"))
...
# Load parcel library module for region partitioning
source(file.path(source_path, "parcel_library.R"))
source(file.path(source_path, "bfs_utils.R"))
