...
# Tuning values actually used by this run (not re-sourced from the raw config
# files) — read straight from the constructed specs.
target_spec <- tar_read(target_spec)
sampler_spec <- tar_read(sampler_spec)
discovery_spec <- tar_read(discovery_spec)
...
SWAP_CAP_TOLERANCE <- sampler_spec$swap_cap_tolerance
